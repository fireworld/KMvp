 ...
 * xx.ch@outlook.com
 */
abstract class BaseDialogFragment : DialogFragment(), IBase.View {
    private companion object {
        const val CODE_REQUEST_PERMISSION = 0X2131
    }
    ...
    protected fun requestPermissions(permissions: Array<String>, listener: PermissionListener?) {
        activity?.apply {
            ...
            if (denied.isEmpty()) {
                ...
                this@BaseDialogFragment.requestPermissions(denied.toTypedArray(), CODE_REQUEST_PERMISSION)
            }
        }
    }
